          ...
          <>
            ...
            <div className="mb-6">
              <div style={{ display: "grid", gridTemplateColumns: "auto 1fr auto", alignItems: "center", gap: "12px" }}>
                <button onClick={() => goDate(shiftDate(dateStr, -1))} className="rounded-lg border border-[#334155] bg-[#1E293B] text-sm text-slate-300 transition hover:border-emerald-500/50 hover:text-white cursor-pointer" style={{ minWidth: "44px", minHeight: "44px", padding: "8px 12px" }}>← 이전</button>
                ...
                <button onClick={() => goDate(shiftDate(dateStr, 1))} className="rounded-lg border border-[#334155] bg-[#1E293B] text-sm text-slate-300 transition hover:border-emerald-500/50 hover:text-white cursor-pointer" style={{ minWidth: "44px", minHeight: "44px", padding: "8px 12px" }}>다음 →</button>
              </div>
