    ...
    <FadeSection>
      ...
      <section id="final-cta" className="bg-bg-900 py-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-[600px] mx-auto relative z-10">
          ...
          <a href="/login" className="inline-flex bg-emerald-500 hover:bg-emerald-700 text-white text-[15px] font-bold px-8 py-3.5 rounded-lg transition-all font-body">무료로 시작하기</a>
