    ...
    <FadeSection>
      ...
      <section id="final-cta" className="bg-bg-900 py-20 px-6 text-center relative overflow-hidden">
        <div className="max-w-[600px] mx-auto relative z-10">
          ...
          <a href={KAKAO_CHANNEL_URL} target="_blank" rel="noopener noreferrer" className="inline-flex bg-emerald-500 hover:bg-emerald-700 text-white text-[15px] font-bold px-8 py-4 rounded-xl transition-all font-body">무료로 카톡 받기 →</a>
        </div>
      </section>
    </FadeSection>
  );
