      ...
      <section className="bg-bg-900 py-20 px-6">
        ...
        <div className="max-w-[900px] mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {MODELS.map((m) => (
              <div key={m.name} className="bg-bg-800 border border-bg-700 rounded-[14px] p-5 text-center card-hover">
                <div className="w-12 h-12 rounded-xl bg-[#059669]/10 border border-[#059669]/20 flex items-center justify-center mx-auto mb-3">
                  <span className="text-[#8494A7] font-mono-data font-bold text-lg">{m.icon}</span>
                </div>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="bg-bg-800 border border-bg-700 rounded-[14px] px-6 py-3 text-center">
              <div className="text-xs text-[#566378] mb-1">앙상블 조합</div>
              <div className="text-sm font-bold text-white">Claude AI가 최종 확신도를 결정</div>
            </div>
            <div className="w-px h-8 border-l border-dashed border-bg-700" />
