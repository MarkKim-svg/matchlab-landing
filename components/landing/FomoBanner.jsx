    ...
    <FadeSection>
      <section className="bg-bg-900 py-6 px-6">
        <div className="max-w-[700px] mx-auto">
          {loading ? (
            <div className="bg-bg-800 rounded-xl p-4 border-l-[3px] border-gold-400 animate-pulse">
              <div className="h-4 bg-bg-700 rounded w-48 mb-2" />
              <div className="h-6 bg-bg-700 rounded w-32 mb-2" />
              <div className="h-4 bg-bg-700 rounded w-40" />
            </div>
          ) : (
            <div className="bg-bg-800 rounded-xl p-4 border-l-[3px] border-gold-400">
              <div className="text-[#94A3B8] text-[14px] mb-1">🔒 지난 7일 유료 전용 고확신 경기</div>
              ...
              <div className="text-[#94A3B8] text-[14px]">이 결과를 매일 받아보세요</div>
            </div>
          )}
        </div>
      </section>
